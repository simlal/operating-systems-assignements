...
// Fix pour getpagesize(). On ne peut pas inclure unistd.h: conflits.
...
//    extern int errno;
    ...
    // The type of 'size' differs widely between systems and causes
    // incompatibilies. This code shouldnt't be used so it is commented out.
    retVal = recvfrom(sockID, buffer, packetSize, 0,
				   (struct sockaddr *) &uName, (size_t *) &size);   
